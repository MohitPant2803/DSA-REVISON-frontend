...
import Svg, { Path, Circle, Rect, Defs, LinearGradient, Stop, G, Mask } from 'react-native-svg';
...
export const ThemeBackground = React.memo(({ children, style }: ThemeBackgroundProps) => {
  const palette = useThemePalette();
  const activeTheme = palette.id;
